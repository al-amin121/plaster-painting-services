<template>
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
            <RouterLink to="/Service-Details">
                <h5 class="mb-5 text-2xl font-bold text-center text-green-400 tracking-tight text-gree dark:text-white">HDB HOUSE</h5>
            </RouterLink>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">HDB house painting service involves repainting the interior of an HDB flat in Singapore. This can be done for a variety of reasons, such as refreshing the look of the flat.</p>
        </div>
    </div>
</template>